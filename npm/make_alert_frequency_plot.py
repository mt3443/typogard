...
plt.plot(npm_x, npm_y, color='red', label='npm', lw=4)
plt.plot(pypi_x, pypi_y, color='blue', label='PyPI', lw=4)
plt.plot(rubygems_x, rubygems_y, color='green', label='RubyGems', lw=4)
plt.xlabel('Popularity Threshold (Weekly Downloads)')
plt.ylabel('Perpetrators (% of All Packages)')
