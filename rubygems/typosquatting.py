# Typosquatting Detection Scheme (RubyGems)
...
popular_packages = set(open('../data/rubygems_package_names').read().splitlines())
...
def scan_all_init():
    ...
    global packages_df
    packages_df = pd.read_csv('../data/rubygems_download_counts.csv')
...
def get_signal_counts():
    ...
    log = open('../data/rubygems_signal_counts', 'w')
